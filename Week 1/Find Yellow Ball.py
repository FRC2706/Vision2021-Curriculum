...
colHsvLowerYellow = (10, 150, 65)
colHsvUpperYellow = (30, 255, 255)
...
intCounter = 0
strPathName = 'PowerCellFullScale/'
...
while not(flgExit):
    ...
    arrLowerColor = np.array([colHsvLowerYellow])
    arrUpperColor = np.array([colHsvUpperYellow]) 
    ...
    WPICalculatedDistance = (0.583*(10/12)*480)/(2*ih*0.293939)
    print('Calculated distance: ', WPICalculatedDistance)
