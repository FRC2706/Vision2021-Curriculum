...
if booChooser:
    ...
    arrImageFiles.append('cone-00.png')
...
while not(flgExit):
    ...
    #cv2.imshow('mskColor', mskColor)
    #cv2.imshow('mskExcluded',mskExcluded)
